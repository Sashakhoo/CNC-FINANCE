...
Reclassified per the owner (Sep 2026), no longer "·unclear":
...
TRANSACTIONS = [
    ...
    ("2026-08-25", "Invoice #159 — Muhammad Firdaus", "in", "Consulting Revenue", 1350.00, "Muhammad Firdaus"),
    ("2026-08-25", "Payment gateway fee — Bayarcash", "out", "Payment Gateway", 80.00, "Bayarcash"),
    ("2026-08-24", "Invoice #161 — Siti Hajar Binti (Haifa Adelea)", "in", "Consulting Revenue", 1500.00, "Siti Hajar Binti"),
    ("2026-08-21", "Invoice #162 — Koh Wen Han (AI for Workplace)", "in", "Consulting Revenue", 388.00, "Koh Wen Han"),
    ...
    ("2026-08-17", "Invoice #156 — Restoran Tong", "in", "Consulting Revenue", 800.00, "Restoran Tong"),
    ("2026-08-17", "Invoice #157 — Restoran Tong", "in", "Consulting Revenue", 488.00, "Restoran Tong"),
    ("2026-08-16", "Invoice #155 — Ooi Kah Seong (AI for Work)", "in", "Consulting Revenue", 388.00, "Ooi Kah Seong"),
    ...
    ("2026-08-01", "Invoice #117 — CC Crest Consultancy", "in", "Consulting Revenue", 800.00, "CC Crest Consultancy"),
    ("2026-07-31", "Vibe Coding course fee — Lim Yoke Lian", "in", "Course Revenue", 800.00, "Lim Yoke Lian"),
    ("2026-07-30", "AI Automation project — Constance (Chan Siew Fuin)", "in", "Consulting Revenue", 488.00, "Chan Siew Fuin"),
    ...
    ("2026-07-27", "Invoice #117 — CC Crest Consultancy", "in", "Consulting Revenue", 800.00, "CC Crest Consultancy"),
